...
//                 Email: <a href="mailto:info@bphgrowth.com" className="hover:text-white">info@bphgrowth.com</a>
//               </p>
      ...
      <div className="max-w-7xl mx-auto px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-base font-bold mb-4 text-white">Resources</h3>
            <ul className="space-y-3">
              <li><a href="/resource-center" className="text-gray-300 hover:text-white">Planning Guide</a></li>
              <li><a href="/blogs" className="text-gray-300 hover:text-white">Blog</a></li>
              <li><a href="/masterclasses" className="text-gray-300 hover:text-white">Masterclasses</a></li>
            </ul>
          </div>
